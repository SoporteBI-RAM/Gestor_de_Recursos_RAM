...
const CONFIG = {
    ...
    // URL: https://docs.google.com/spreadsheets/d/1uTMjJ_4_uXfZ2u0P9CTMy4pzMBY60e0tzWkM6xnglTk/edit
    ...
    // Dejar vacío hasta que hagas el deployment del script
...
function validarConfiguracion() {
    if (CONFIG.SHEET_ID === 'TU_GOOGLE_SHEET_ID_AQUI') {
